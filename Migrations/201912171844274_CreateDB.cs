namespace WeddingApp.Migrations
{
    ...
    public partial class CreateDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        FunctionDate = c.DateTime(nullable: false),
                        DateAdded = c.DateTime(nullable: false),
                        Notes = c.String(nullable: false),
                        WeddingPackageId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.WeddingPackages", t => t.WeddingPackageId, cascadeDelete: true)
                .Index(t => t.WeddingPackageId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Functions", "WeddingPackageId", "dbo.WeddingPackages");
            ...
            DropIndex("dbo.Functions", new[] { "WeddingPackageId" });
            DropIndex("dbo.Enquiries", new[] { "EnquiryCategoryId" });
            DropTable("dbo.WeddingDetails");
